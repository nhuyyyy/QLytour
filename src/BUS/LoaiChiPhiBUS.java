...
public class LoaiChiPhiBUS {
    public static List<LoaiChiPhi> ds;
  ...
  public void docduLieusearch(Map<String,String> nv) throws Exception{
               LoaiChiPhiDAO nvdao= new LoaiChiPhiDAO();
       
                ds = nvdao.getLoaiCP(nv);
   ...
   public DTO.LoaiChiPhi getLoaiChiPhi(String tenlcp)
   {
    ...
    public String remindMaloaichiphi() {
     ...
     public List<LoaiChiPhi> getLChiphi(Map<String,String> nv) throws Exception{
              LoaiChiPhiDAO nvdao= new LoaiChiPhiDAO();
              List<LoaiChiPhi> dsnv = nvdao.getLoaiCP(nv);
              return dsnv;
}
}
